...
class UserProfile(AbstractBaseUser):
    ...
    stu_obj=models.ForeignKey('Customer',blank=True,null=True
                              ,help_text="请在用户正式成为学员后给该用户创建账户！")
...
class Menu(models.Model):
    ...
    menu_choice=((0,'related'),
                 (1,'direct')
                 )

    type=models.SmallIntegerField(choices=menu_choice)
